...
const Create = () => {
  ...
  const formSubmit = (e) => {
    ...
    axios
      .post("https://649172902f2c7ee6c2c83e44.mockapi.io/assignment", {
        name: name,
        email: email,
        phone: phone,
        header,
      ...
      >
        ...
        <label className="relative text-[#fff]/70 focus-within:text-[#fff]/70 block mb-4">
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className="transition pfy-cer-events-none w-6 h-6 absolute top-1/2 transform -translate-y-1/2 left-3"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Link to="/">
          <button
            className="bg-blue-600 hover:bg-blue-700 w-full p-2 md:p-3 rounded-md font-bold text-lg transition-colors duration-500 mt-3"
            type="button"
          >
            Show Data
          </button>
